...
export const translations = {
  bn: {
    ...
    news: {
      title: 'লাইভ নিউজ হাব',
      subtitle: 'উজিরপুর বার্নিয়া, পশ্চিমবঙ্গ এবং ভারতের সর্বশেষ খবর। প্রতিদিন সকাল ৬টায় আপডেট করা হয়।',
      local: 'স্থানীয় সংবাদ (উজিরপুর বার্নিয়া)',
      westBengal: 'পশ্চিমবঙ্গ সংবাদ',
      india: 'ভারত সংবাদ',
      source: 'সূত্র',
      date: 'তারিখ',
  ...
  en: {
    ...
    news: {
      title: 'Live News Hub',
      subtitle: 'Latest news from Ujirpur Barnia, West Bengal, and India. Updated daily at 6 AM.',
      local: 'Local News (Ujirpur Barnia)',
      westBengal: 'West Bengal News',
      india: 'India News',
      source: 'Source',
      date: 'Date',
