...
export const AdminAnalytics = () => {
  ...
  const downloadVamshavaliManual = () => {
    const toastId = toast.loading("Preparing your project manual...");
    try {
      ...
      addTitle("Vamshavali: Digital Lineage Manual");
      addSection("1. Introduction", [
        "Vamshavali is Barnia Digital Hub's premier tool for preserving your family history. This application allows families to build a visual representation of their genealogy, known as a 'Grand History' or Family Tree.",
        "This manual provides step-by-step instructions for operating the platform effectively for your school project or personal use."
      ]);
      addSection("2. Building the Tree", [
      ...
      doc.text("Generated by Barnia Digital Hub - Vamshavali Project Support", margin, 285);
      doc.save("Vamshavali_Operating_Manual.pdf");
      toast.dismiss(toastId);
      toast.success("Project Manual downloaded successfully!");
    } catch (error) {
      console.error("Manual Download Error:", error);
      toast.dismiss(toastId);
      toast.error("Failed to generate manual. If you're in preview, try 'Open in new tab'.");
    }
  };
